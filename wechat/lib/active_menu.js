...
exports._createMenu = function (menu, callback) {
  var url = config.OpenAPI.apiURL + 'menu/create?access_token=' + this.token.accessToken;
...
exports._getMenu = function (callback) {
  var url = config.OpenAPI.apiURL + 'menu/get?access_token=' + this.token.accessToken;
...
exports._removeMenu = function (callback) {
  var url = config.OpenAPI.apiURL + 'menu/delete?access_token=' + this.token.accessToken;
  this.request(url, {dataType: 'json'}, wrapper(callback));
};
...
exports._getMenuConfig = function (callback) {
  var url = config.OpenAPI.apiURL + 'get_current_selfmenu_info?access_token=' + this.token.accessToken;
  this.request(url, {dataType: 'json'}, wrapper(callback));
};